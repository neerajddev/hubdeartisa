...
export default function ArtistProjectMessagesPage() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel(`project_messages:artist:${projectId}`)
      .on(
        'postgres_changes',
        {
          event: 'INSERT',
    ...
    <Layout>
      ...
      <header className={styles.pageHeader}>
        <div className="container">
          <Link href={ROUTES.artistJobWorkspace(projectId)} className={styles.backLink}>
        ...
        <div className="container">
          <div className={styles.chatCard}>
            ...
            <div className={styles.messagesList}>
              ...
              {messages.map((msg) => {
                const isMine = msg.sender_role === 'artist';
                return (
                  <div
                    key={msg.id}
                  ...
                  >
                    {!isMine && (
                      <div className={styles.avatarTheirs} aria-label="Client">C</div>
                    )}
                    <div
                    ...
                    {isMine && (
                      <div className={styles.avatarMine} aria-label="You">A</div>
                    )}
                  </div>
                );
              })}
